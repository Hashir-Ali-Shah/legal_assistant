...
DOCUMENT_CONFIGS = {
    ...
    "Contract_Act_1872.doc.pdf": {
        "document_name": "Contract Act 1872",
        "document_type": "contract_law",
    ...
    "Muslim-Family-Laws-Ordinance-1961.pdf": {
        "document_name": "Muslim Family Laws Ordinance 1961",
        "document_type": "family_law",
        "namespace": "family_law",
        "chunk_size": 800,
        "chunk_overlap": 100,
        "patterns": {
            "section": r"Section\s+(\d+[A-Z]?)",
    ...
    "Property-Law-Transfer-of-Property-Act-1872.pdf": {
        "document_name": "Transfer of Property Act 1882",
        "document_type": "property_law",
        "namespace": "property_law",
        "chunk_size": 1000,
        "chunk_overlap": 100,
        "patterns": {
            "section": r"Section\s+(\d+[A-Z]?)",
    ...
    "SPECIFIC_RELIEF_ACT,_1877.doc.pdf": {
        "document_name": "Specific Relief Act 1877",
        "document_type": "property_law",
        "namespace": "property_law",
        "chunk_size": 1000,
        "chunk_overlap": 100,
    ...
    "family-courts-act-1964-xxxv-of-1964-pdf.pdf": {
        "document_name": "Family Courts Act 1964",
        "document_type": "family_law",
        "namespace": "family_law",
        "chunk_size": 800,
        "chunk_overlap": 100,
    ...
    "guardians_and_wards act.pdf": {
        "document_name": "Guardians and Wards Act 1890",
        "document_type": "family_law",
        "namespace": "family_law",
        "chunk_size": 800,
        "chunk_overlap": 100,
    ...
    "industrial_relations_act.pdf": {
        "document_name": "Industrial Relations Act 2012",
    ...
    "qanun-e-shahadat-order-1984-doc-pdf.pdf": {
        "document_name": "Qanun-e-Shahadat Order 1984",
        "document_type": "evidence_law",
        "namespace": "evidence_law",
        "chunk_size": 1000,
        "chunk_overlap": 100,
        "patterns": {
            "article": r"Article\s+(\d+[A-Z]?)",
    ...
    "registration-act-1908-pdf.pdf": {
        "document_name": "Registration Act 1908",
        "document_type": "property_law",
        "namespace": "property_law",
        "chunk_size": 1000,
        "chunk_overlap": 100,
